        ...
        <v-card-text>
          <v-tabs-window v-model="tab">
            <v-tabs-window-item value="comments">
              <div class="mt-4">
                <v-textarea v-model="newComment" variant="outlined" label="Add a comment"
                  placeholder="Write your comment here..." rows="3" />
                <v-btn type="submit" color="#3E4E3C" block @click="addComment">
                  Add
                </v-btn>
                  ...
                  <div class="d-flex align-center justify-start">
                    ...
                    <v-card-text class="pa-2">
                      <div class="d-flex justify-start align-center">
                        ...
                        <span class="text-caption text-grey-darken-1">{{ formatDate(comment.created) }}</span>
                      </div>
                      <div>{{ comment.content }}</div>
                      <span class="ml-auto text-red d-flex justify-end" small @click="deleteComment(comment.id)">
                        Delete
                      </span>
                    </v-card-text>
                  </div>
